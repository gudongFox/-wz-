    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span >正文文件</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div  class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <label style="margin-right: 10px;">文件名：<input type="search"
                                                                         class="form-control input-inline input-sm"
                                                                         placeholder="文件名"
                                                                         ng-model="vm.params.fileName"></label>
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.fileName" class="data_title"  ng-click="vm.show(item.id);"><strong ></strong></td>
                                <td ng-bind="item.localPath"></td>
                                <td ng-bind="item.creatorName"></td>
                                <td ng-bind="item.gmtCreate|date:'yyyy-MM-dd'"></td>
                                <td><i class="fa fa-download  margin-right-5" ng-click="vm.downloadContent(item.businessKey);" title="下载"></i></td>
                                <%--<td>
