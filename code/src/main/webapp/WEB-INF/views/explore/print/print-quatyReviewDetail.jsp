...
<div id="print_area" style="display: none;">
    ...
    <table class="print_table">
        <tr>
            ...
            <td style="width: 20%;border-top: none">审核人</td>
            <td style="width: 30%;border-top: none" ng-bind="vm.printData.auditMan+' '+vm.printData.auditTime"></td>
        </tr>
        <tr>
            <td style="width: 20%">审定人</td>
            <td style="width: 30%" ng-bind="vm.printData.approveMan+' '+vm.printData.approveTime"></td>
            <td></td>
            <td></td>
        </tr>
    </table>
