...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-envelope-letter"></i> 变更及过程资料用印申请
            ...
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="file in files">
                    ...
                    <td style="text-align: left;">
                        ...
                        <span ng-bind="file.fileName" ng-show="!processInstance.firstTask"></span>
                    </td>
                    ...
                    <td>
                        <i class="fa fa-download margin-right-5" ng-click="download(file.sysAttach.id);"
                           title="下载"></i>
                        <i class="fa fa-trash" ng-show="file.creator==user.userLogin&&processInstance.firstTask"
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'设计过程资料'}:true"
