...
<head>
    <meta charset="utf-8"/>
    <title>Page No Permission</title>
    ...
    <link href="/m/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="/m/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<script src="/m/global/plugins/jquery.cokie.min.js" type="text/javascript"></script>
<script src="/m/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
<script src="/m/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
...
<script src="/m/admin/layout/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="/m/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script>
