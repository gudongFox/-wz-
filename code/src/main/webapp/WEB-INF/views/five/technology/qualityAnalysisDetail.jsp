...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-calculator"></i> 设计质量剖析
        ...
        <div class="actions">
            ...
            <a class="btn btn-sm btn-default" ng-href="{{'/five/qualityAnalysis/exportData.json?id='+vm.item.id}}"
               target="_blank">
                ...
                <div class="tab-pane active" id="tab_15_1"
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">概要说明</label>
                                <div class="col-md-10">
                            ...
                            <p class="text-right"><a href="/assets/doc/five/设计项目质量剖析管理规定.doc" target="_blank" style="text-decoration: none;">设计项目质量剖析管理规定.doc</a> </p>
                        </div>
                    </form>
                </div>
