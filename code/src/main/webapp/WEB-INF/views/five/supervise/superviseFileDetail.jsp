...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a ui-sref="oa.functionEntrance({moduleId:79})">督办管理</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <span ng-bind="vm.item.superviseType"></span>
        </li>
    </ul>
</div>
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i> <span ng-bind="tableName">文件督办</span>
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.name as s.name for s in sysCodes | filter:{codeCatalog:'督办类型'}:true"
                                            ng-model="vm.item.superviseType" class="form-control" disabled></select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label required">办理人</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.transactorName" name="transactorName"  required="true" ng-disabled="processInstance.currentTaskName.indexOf('部门负责人')==-1" />
                                        <span class="input-group-btn" >
                                                <button class="btn default" type="button" ng-click="vm.showUserModel('transactor');" ng-disabled="processInstance.currentTaskName.indexOf('部门负责人')==-1"><i class="fa fa-user"></i></button>
                                            </span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label ">办理人意见</label>
                                <div class="col-md-10">

                                    <textarea rows="3" class="form-control" ng-model="vm.item.transactorOpinion" name="transactorOpinion" placeholder="" ng-disabled="processInstance.currentTaskName.indexOf('办理人')==-1"></textarea>
                                </div>
                            </div>
