...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">文件督办</span>
        </li>
    </ul>
</div>
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.fileHeader"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong></td>
                                <td ng-bind="item.deptName"></td>
                                <td ng-bind="item.transactorName" ></td>
                                <td ng-bind="item.feedbackTime" ></td>
                                <td ng-bind="item.transactionPlan" ></td>
                                <td ng-bind="item.companyLeaderName"></td>
