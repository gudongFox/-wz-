...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">常规督办</span>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span ng-bind="tableName">常规督办</span>
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.fileHeader"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.superviseType" ></td>
