...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-shield"></i> 设计成果文件输出
        </div>
        <div class="actions">
            ...
            <div class="table-scrollable">
                <table class="table table-striped table-hover table-bordered table-advance no-footer">
                    ...
                    <tr>
                        ...
                        <th>期次名称</th>
                        <th style="width: 110px;">专业名称</th>
                        <th style="width: 90px;">文件类别</th>
                       <%-- <th style="width: 90px;">用印明细</th>--%>
                        <th style="width: 120px;">用印时间</th>
                    ...
                    <tr ng-repeat="item in vm.list">
                        ...
                        <td ng-bind="item.majors"></td>
                        <td ng-bind="item.docType"></td>
                       <%-- <td ng-bind="item.useStamp"></td>--%>
                        <td ng-bind="item.useTime|date:'yyyy-MM-dd'"></td>
