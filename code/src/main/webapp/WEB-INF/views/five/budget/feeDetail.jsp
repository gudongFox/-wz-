...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">收费预算</span>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" style="padding-right: 30px;">
                    <div class="form-body">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" ng-model="vm.detail.typeName"
                                           ng-disabled="!vm.detail.isParent"
                                           name="typeName" maxlength="100"/>
                                    <span class="input-group-btn">
                                            <button class="btn default" type="button"
                                                    ng-disabled="!processInstance.firstTask"
                                                    ng-click="vm.showDeptModal(vm.opt='detailDeptId')"> <i
                                                    class="fa fa-cog"></i></button>
                                        </span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label required">勘察设计、咨询收费</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.designFee"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label required">工程承包收费</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.projectFee"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label required">其他收费</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.otherFee"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
