...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">专项维修经费预算</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i> <span ng-bind="tableName">专项维修经费预算</span>
...
<div class="portlet light" ng-if="vm.lastDetails.length>0">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-file"></i><span ng-bind="vm.item.lastYear+' 预算明细'"/>
        </div>
        <div class="tools">
        ...
        <div class="table-scrollable" style="max-height: {{contentHeight-250}}px;overflow-y: auto;overflow-x: hidden;">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="detail in vm.lastDetails">
                    ...
                    <td ng-bind="detail.systemName" class="data_title" ng-click="vm.showDetailModel1(detail.id);"></td>
                    <td ng-bind="detail.projectType"></td>
                    <td ng-bind="detail.projectName"></td>
                    <td ng-bind="detail.workContent"></td>
                    <td ng-bind="detail.projectContent"></td>
                    <td ng-bind="detail.budgetMoney"></td>
                    <td>
                        <i class="fa fa-pencil margin-right-5" ng-click="vm.showDetailModel1(detail.id);"
                           title="详情"></i>
                    </td>
                </tr>
                </tbody>
...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span style="padding-left:15px;font-size: 14px;color: red">总计金额:&nbsp;<span style="color:black"
                                                                                        ng-bind="vm.item.totalBudgetMoney"/>&nbsp;&nbsp;&nbsp;</span>
        </div>
        <div class="actions">
        ...
        <div class="table-scrollable" style="max-height: {{contentHeight-250}}px;overflow-y: auto;overflow-x: hidden;">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="detail in vm.details">
                    <td class="dt-right" ng-bind="$index+1"></td>
                    <td ng-bind="detail.systemName" class="data_title" ng-click="vm.showDetailModel(detail.id);"></td>
                    <td ng-bind="detail.projectType"></td>
                    <td ng-bind="detail.projectName"></td>
                    <td ng-bind="detail.workContent"></td>
                    <td ng-bind="detail.projectContent"></td>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="detailForm">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label required">系统名称</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" ng-model="vm.detail.systemName"
                                       name="systemName" required="true" ng-disabled="!processInstance.firstTask">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label required">项目类型</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" ng-model="vm.detail.projectType"
                                       name="projectType" required="true" ng-disabled="!processInstance.firstTask">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label required">工作内容</label>
                            <div class="col-md-9">
                                <textarea class="form-control" rows="3" ng-model="vm.detail.workContent"
                                          name="workContent" required="true" ng-disabled="!processInstance.firstTask"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label required">工程内容</label>
                            <div class="col-md-9">
                                <textarea class="form-control" rows="3" ng-model="vm.detail.projectContent"
                                          name="projectContent" required="true"
                                          ng-disabled="!processInstance.firstTask"/>
                            </div>
                        </div>
                    </div>
                ...
                <form class="form-horizontal" role="form" id="detailForm1">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" ng-model="vm.detail.systemName"
                                       name="systemName" required="true" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label required">项目类型</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" ng-model="vm.detail.projectType"
                                       name="projectType" required="true" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label required">预算资金</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" rows="3" ng-model="vm.detail.workContent"
                                          name="workContent" required="true" readonly/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label required">工程内容</label>
                            <div class="col-md-9">
                                <textarea class="form-control" rows="3" ng-model="vm.detail.projectContent"
                                          name="projectContent" required="true" readonly/>
                            </div>
                        </div>
                    </div>
