...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">资本性支出预算</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">资本性支出预算</span>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" style="padding-right: 30px;">
                    <div class="form-body">
                        ...
                        <div class="form-group" ng-if="vm.item.deptId==11">
                            <label class="col-md-3 control-label required">办公自动化</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                <input type="text" class="form-control" ng-model="vm.detail.oaMoney" ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                                </div>
                        </div>
                        <div class="form-group" ng-if="vm.item.deptId==67">
                            <label class="col-md-3 control-label required">办公家具</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                <input type="text" class="form-control" ng-model="vm.detail.furnitureMoney" ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" ng-if="vm.item.deptId==59">
                            <label class="col-md-3 control-label required">车辆预算</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                        ...
                        <div class="form-group" ng-if="vm.item.deptId==11">
                            <label class="col-md-3 control-label required">软件预算</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                <input type="text" class="form-control" ng-model="vm.detail.softMoney" ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </div>
