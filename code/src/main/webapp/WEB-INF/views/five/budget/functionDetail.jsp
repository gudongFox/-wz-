...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">职能管理部门预算</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">职能管理部门预算</span>
        ...
        <div class="tabbable-line">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_15_1"
                    ...
                    <form class="form-horizontal form-validate" role="form" id="detail_form">
                        <div class="form-body">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" style="padding-right: 30px;">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">是否为公共预算</label>
                            <div class="col-md-9">
