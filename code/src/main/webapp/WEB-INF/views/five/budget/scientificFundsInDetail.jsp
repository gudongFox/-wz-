                ...
                <form class="form-horizontal" role="form" style="padding-right: 30px;">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" ng-model="vm.detail.typeName"
                                       ng-disabled="!processInstance.firstTask" placeholder="">
                            </div>
                        </div>

                        <div class="form-group" ng-if="!vm.detail.isParent">
                            <label class="col-md-2 control-label required">批准文号</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" ng-model="vm.detail.allowNo"
                                       ng-disabled="!processInstance.firstTask||vm.detail.isParent" placeholder="">
                            </div>
                            <label class="col-md-2 control-label required">研制（研发）总目标</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" ng-model="vm.detail.totalTarget"
                                       ng-disabled="!processInstance.firstTask||vm.detail.isParent" placeholder="">
                            </div>
                        </div>
                        <div class="form-group" ng-if="!vm.detail.isParent">
                            <label class="col-md-2 control-label required">项目开始时间</label>
                            <div class="col-md-4">
                                <div class="input-group date date-picker" id="planBeginTime">
                                    <input type="text" class="form-control"
                                           ng-model="vm.detail.beginTime" required="true"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-btn">
                                    <button class="btn default" type="button"
                                            ng-disabled="!processInstance.firstTask||vm.detail.isParent"><i
                                            class="fa fa-calendar"></i></button></span>
                                </div>
                            </div>

                            <label class="col-md-2 control-label required">项目结束时间</label>
                            <div class="col-md-4">
                                <div class="input-group date date-picker" id="planEndTime">
                                    <input type="text" class="form-control"
                                           ng-model="vm.detail.endTime" required="true"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-btn">
                                 <button class="btn default" type="button"
                                         ng-disabled="!processInstance.firstTask||vm.detail.isParent"><i
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label required">项目总经费</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.projectTotalMoney"
                                           readonly>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            <label class="col-md-2 control-label required">国拨资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.countryMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label required">自筹资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.selfMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            <label class="col-md-2 control-label required">其他资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.otherMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label required">本年项目经费</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.projectYearMoney"
                                           readonly>
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            <label class="col-md-2 control-label required">本年国拨资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.yearCountryMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label required">本年自筹资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.yearSelfMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            <label class="col-md-2 control-label required">本年其他资金</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.yearOtherMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label ">项目累计经费收入</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.projectAddInMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                            <label class="col-md-2 control-label ">项目累计经费支出</label>
                            <div class="col-md-4">

                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                    <input type="text" class="form-control" ng-model="vm.detail.projectAddOutMoney"
                                           ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
