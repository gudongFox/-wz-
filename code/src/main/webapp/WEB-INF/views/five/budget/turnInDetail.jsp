...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">上缴分红预算</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">上缴分红预算</span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">预算详情</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" style="padding-right: 30px;">
                    <div class="form-body">
                        <div class="form-group" ng-if="!vm.detail.isParent&&vm.detail.deptId==0">
                            <label class="col-md-3 control-label required" >是否为外部资产</label>
                            <div class="col-md-9">
                                <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'是否'}:true"
                                        ng-model="vm.detail.outAssert" class="form-control" ng-disabled="!processInstance.firstTask"></select>
                            </div>
                        </div>
                        <div class="form-group" ng-if="!vm.detail.outAssert">
                        ...
                        <div class="form-group" ng-if="vm.detail.outAssert&&!vm.detail.isParent">
                            <label class="col-md-3 control-label required"  ng-if="!vm.detail.isParent">外部资产名称</label>
                            <div class="col-md-9">
                                    <input type="text" class="form-control" ng-model="vm.detail.typeName" ng-disabled="!processInstance.firstTask"
                                           name="typeName" maxlength="100"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            <label class="col-md-3 control-label required">上缴利润</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                <input type="text" class="form-control" ng-model="vm.detail.turnProfits" ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" >
                            <label class="col-md-3 control-label required">发展基金</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">￥</span>
                                <input type="text" class="form-control" ng-model="vm.detail.developmentFund" ng-disabled="!processInstance.firstTask||vm.detail.isParent">
                                    <span class="input-group-addon">万元</span>
                                </div>
                            </div>
                        </div>
