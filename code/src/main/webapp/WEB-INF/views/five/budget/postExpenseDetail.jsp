...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">职务消费预算</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">职务消费预算</span>
...
<div class="portlet light">
    ...
    <span style="color: red;font-size: 12px">注释：1.本表中的配备公务用车，是指以购置方式为企业负责人配备公务活动专车的管理方式。 2.公务用车运行费用包括保养、维修费用，以及燃料费、停车和过桥过路费、保险费、年检费、车船使用税等日常使用费用。</span>
</div>
