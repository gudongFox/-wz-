            ...
            <div class="table-scrollable">
                <table class="table table-striped table-hover table-bordered table-advance no-footer">
                    ...
                    <tr>
                        ...
                        <th style="width: 90px;">提出专业</th>
                        <th style="width: 250px;">接收专业</th>
                        <th>提出说明</th>
                    ...
                    <tr ng-repeat="item in vm.list">
                        ...
                        <td ng-bind="item.sourceMajor" class="data_title" ng-click="vm.show(item.id);"></td>
                        <td ng-bind="item.destMajor"></td>
                        <td ng-bind="item.referDesc"></td>
