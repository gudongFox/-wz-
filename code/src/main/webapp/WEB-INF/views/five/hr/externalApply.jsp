    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-database"></i> 外聘技术人员录用审批
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>聘用部门</th>
                                <th style="width: 70px">申报年度</th>
                                <th style="width: 100px">聘用岗位</th>
                                <th style="width: 100px">聘用专业</th>
                                <th style="width: 115px">聘用人员类型</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.checkYear+'年'" ></td>
                                <td ng-bind="item.planPost"></td>
                                <td ng-bind="item.planMajor"></td>
