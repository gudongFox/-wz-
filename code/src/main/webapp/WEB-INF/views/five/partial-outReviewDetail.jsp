...
<div class="portlet  box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a class="btn btn-sm btn-default" ng-href="{{'/five/outReview/exportData.json?id='+vm.item.id}}"
               target="_blank">
        ...
        <div class="tabbable-line">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_15_1"
                     style="min-height: 250px;overflow-y: auto;overflow-x: hidden;">
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">评审级别</label>
                                <div class="col-md-4">
                                    <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'评审级别'}:true"
                                            ng-model="vm.item.reviewLevel" class="form-control"
                                            ng-disabled="!processInstance.firstTask">

                                    </select>
                                </div>
                                <label class="col-md-2 control-label">评审类别</label>
                                <div class="col-md-4">
                                    <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'评审类别'}:true"
                                            ng-model="vm.item.reviewType" class="form-control"
                                            ng-disabled="!processInstance.firstTask">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">参会人</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" ng-model="vm.item.attendUser" name="attendUser" maxlength="100" ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
