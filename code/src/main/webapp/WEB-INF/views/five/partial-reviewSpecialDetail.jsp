...
<div class="portlet  box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a class="btn btn-sm btn-default" ng-href="{{'/five/task/exportData.json?id='+vm.item.id}}"
               target="_blank">
    ...
    <div class="portlet-body">
        <div class="tabbable-line">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_detail_1"
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label ">评审主持人</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.hostMenName" name="hostMenName"
                                               readonly/>
                                        <span class="input-group-btn">
                                        <button class="btn default" type="button"
                                                ng-click="vm.currentUser=user;vm.opt ='hostMen';vm.optUser=vm.item.hostMen;vm.showUserModel();"
                                                ng-disabled="processInstance.myRunningTaskName.indexOf('专家委员会')==-1"><i class="fa fa-user"></i></button>
                                        </span>
                                    </div>
                                    <span class="help-block"  ng-show="processInstance.myRunningTaskName.indexOf('专家委员会')>=0">请点击后方按钮选择</span>
                                </div>
                                <label class="col-md-2 control-label required">参与人员</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.attendUser"  ng-disabled="processInstance.myRunningTaskName.indexOf('专家委员会')==-1"/>
                                </div>
                ...
                <div class="tab-pane" id="tab_detail_3" style="height: 280px;overflow-y: auto;overflow-x: hidden;">
