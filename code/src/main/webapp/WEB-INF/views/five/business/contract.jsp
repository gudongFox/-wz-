...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-star"></i> <span ng-bind="tableName">项目启动</span>
        </div>
        <div class="actions">
            ...
            <div class="table-scrollable">
                <table class="table table-striped table-hover table-bordered table-advance no-footer">
                    ...
                    <tr>
                        ...
                        <th style="width: 110px;">档案号</th>
                        <th style="width: 160px;">部门名称</th>
                       <%-- <th style="width: 110px;">合同金额</th>--%>
                        <th>客户名称</th>
                    ...
                    <tr ng-repeat="item in vm.pageInfo.list">
                        ...
                        <td ng-bind="item.businessContractDetail.projectNo"></td>
                        <td ng-bind="item.recordNo"></td>
