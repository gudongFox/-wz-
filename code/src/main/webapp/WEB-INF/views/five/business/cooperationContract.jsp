                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="width: 160px;">内部合作项目名称</th>
                                <th style="width: 160px;">内部合作项目号</th>
                                <th style="width: 160px;">内部合作合同名称</th>
                                <th style="width: 160px;">内部合作合同号</th>
                                <th>备注</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.cooperationProjectName" class="data_title"  ng-click="vm.show(item.id);"></td>
                                <td ng-bind="item.cooperationProjectNo"></td>
