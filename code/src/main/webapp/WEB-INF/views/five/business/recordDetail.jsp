...
<%--                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="planBeginTime">
                                        <input type="text" class="form-control"
                                               ...
                                               ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0">
                                        <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectAddress" name="projectAddress" required="true"   ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">建设规模</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectScale" name="projectScale" required="true"   ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"/>
                                </div>
                                <label class="col-md-2 control-label required">投资额度（万元）</label>
                                <div class="col-md-4">
                                    <input  type="text" class="form-control" ng-model="vm.item.projectInvest" name="projectInvest" required="true"   ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.businessContent" name="businessContent" required="true"   ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn" >
                                            <button class="btn default" type="button" ng-click="vm.showUserModel(vm.opt='businessUser');" ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"><i class="fa fa-user"></i></button>
                                        </span>
                                    </div>
                          ...
                          <%--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="bidPlanOpen">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.bidPlanOpen" name="bidPlanOpen"  ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0"  >
                                        <span class="input-group-btn">
                              ...
                              <%--  <label class="col-md-2 control-label">实际开标时间</label>
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'是否中标'}:true"
                                            ng-model="vm.item.secret" class="form-control" ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0" ></select>
                                    <span class="help-block"  ng-if="vm.item.secret" ng-show="processInstance.firstTask" style="color: red">此平台为非密平台，严禁录入涉密信息，请确认。</span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'是否中标'}:true"
                                            ng-model="vm.item.attend" class="form-control" ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0" ></select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" ng-model="vm.item.remark"  name="remark" maxlength="200"
                                           ng-disabled="!processInstance.firstTask&&processInstance.myRunningTaskName.indexOf('经营发展部人员')<0" placeholder="" />
                                </div>
                            </div>
