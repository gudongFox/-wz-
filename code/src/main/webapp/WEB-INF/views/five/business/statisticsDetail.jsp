        ...
        <div class="tabbable-line">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_15_1"
                     style="min-height: 100px;overflow-y: auto;overflow-x: hidden;">
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group" >
                                <label class="col-md-2 control-label required">报表类型</label>
                                <div class="col-md-4" >
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker-year-month" >
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.startTime" required="true" id="startTime" readonly>
                                        <span class="input-group-btn">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker-year-month" >
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.endTime" required="true" id="endTime" readonly>
                                        <span class="input-group-btn">
                                    <button class="btn default" type="button"><i
                                            class="fa fa-calendar"></i></button></span>
                                    </div>
...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-file"></i>明细 <span style="margin-left: 30px;color: red;font-size: 12px"></span></span>
