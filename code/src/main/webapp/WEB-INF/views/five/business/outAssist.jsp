...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">月度外协费费用支出明细</span>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span ng-bind="tableName">月度外协费费用支出明细</span>
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="width: 160px;">填写单位</th>
                                <th style="width: 160px;">申报时间</th>
                                <th>备注</th>
