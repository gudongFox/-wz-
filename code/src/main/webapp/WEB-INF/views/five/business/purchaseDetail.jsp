                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group" ng-if="vm.item.isReplenish">
                                <label class="col-md-2 control-label required" >采购合同名称</label>
                                <div class="col-md-4" >
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.mainContractLibraryName"
                                               name="mainContractLibraryName" required="true" disabled/>
                                        <span class="input-group-btn">
                                ...
                                <label class="col-md-2 control-label required" >采购合同号</label>
                                <div class="col-md-4" >
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required" ng-if="!vm.item.isReplenish"><strong>采购合同名称</strong></label>
                                <label class="col-md-2 control-label required" ng-if="vm.item.isReplenish"><strong>补充采购合同名称</strong></label>
                                <div class="col-md-4">
                                ...
                                <label class="col-md-2 control-label required">采购合同类型</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.subContractType" name="subContractType" required="true"   readonly/>
                                   <%-- <select ng-options="s.name as s.name for s in sysCodes | filter:{codeCatalog:'采购合同类型'}:true"
                                            ng-model="vm.item.subContractType" class="form-control"
                                            ng-disabled="!processInstance.firstTask"></select>--%>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">采购合同额（万元）</label>
                                <div class="col-md-4">
                                ...
                                <label class="col-md-2 control-label required" style="font-weight: bold;">采购合同号</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-md-4">
                                    <input ng-model="vm.item.subContractMoney" name="subContractMoney" required class="form-control" ng-disabled="!processInstance.firstTask">
                                </div>
                            </div>
                            <div class="form-group" >
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">采购合同主要情况说明</label>
                                <div class="col-md-10">
