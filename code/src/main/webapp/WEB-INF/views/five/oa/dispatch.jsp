...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">公司发文</span>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i><span ng-bind="tableName">公司发文</span>
                </div>
                <div class="actions">
                ...
                <div class="no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label style="margin-right: 10px;">发文类型：
                                <select ng-options="s.code  as s.name for s in vm.listType"
                                        ng-model="vm.params.dispatchType" class="form-control input-inline input-sm"></select>
                            </label>--%>
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">发文类型</th>
                                <th style="width: 150px;">主办单位</th>
                                <th style="width: 60px">签发人</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.dispatchTitle"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.dispatchType"></td>
                                <td ng-bind="item.deptName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.signerName"></td>
