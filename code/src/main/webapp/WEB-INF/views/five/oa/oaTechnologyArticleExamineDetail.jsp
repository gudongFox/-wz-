...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">对外发表论文审查</span>
        </li>
    </ul>
</div>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">对外发表论文审查</span>
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label required">作者单位</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label required">作者联系方式</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.technologyChargeManName" name="technologyChargeManName" required="true"   ng-disabled="!processInstance.firstTask"/>
                                        <span class="input-group-btn" >
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">拟发表刊物或学术交流</label>
                                <div class="col-md-10">
                                    <textarea rows="3" type="text" class="form-control" ng-model="vm.item.periodical" name="periodical" required="true"   ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label required">审查要点</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.examineTips" required="true" name="examineTips" placeholder=""ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                           <%-- <div class="form-group">
                                <label class="col-md-2 control-label ">部门审查意见</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label ">技术质量部审查意见</label>
                                <div class="col-md-10">
...
<jsp:include page="../print/print-oaTechnologyArticleExamineDetail.jsp"/>