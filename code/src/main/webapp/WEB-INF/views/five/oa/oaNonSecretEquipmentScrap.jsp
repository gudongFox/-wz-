                ...
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <%--   <label style="margin-right: 10px;">单位名称：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 100px;">信息化设备编号</th>
                                <th style="min-width: 100px;">设备序列号</th>
                                <th style="min-width: 200px;">报废原因</th>
                                <th>单位名称</th>
                                <th>设备名称</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.equipmentNo"  class="data_title"  ng-click="vm.show(item.id);"></td>
                                <td ng-bind="item.equipmentSerial" ></td>
                                <td ng-bind="item.scrapReason" ></td>
