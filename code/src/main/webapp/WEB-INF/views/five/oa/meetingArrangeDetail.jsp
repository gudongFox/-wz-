...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-envelope-letter"></i> <span ng-bind="tableName">会议室管理</span>
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.meetingName" required name="meetingName" ng-disabled="!processInstance.firstTask"/>
                                </div>
                                <label class="col-md-2 control-label required">会议日期</label>
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="meetingTime">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.meetingTime" name="meetingTime" required="true" ng-disabled="!processInstance.firstTask"  >
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label required">会议室</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.room" name="room"    ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">会议概要</label>
                                <div class="col-md-10">
                                    <textarea rows="3" type="text" class="form-control" required ng-model="vm.item.meetingDes" name="meetingDes"  ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
