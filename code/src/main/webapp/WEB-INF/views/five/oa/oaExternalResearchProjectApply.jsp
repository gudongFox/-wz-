                ...
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn green btn-sm defaultBtn" ng-click="vm.downExcel();"><i class="fa fa-download"></i> 导出EXCL </a>
                        </div>
                    </div>
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="width: 90px">本年度还款（万元）</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.yearRepayment"></td>
