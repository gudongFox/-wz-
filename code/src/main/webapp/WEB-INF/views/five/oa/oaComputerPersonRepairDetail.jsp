...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span >信息化设备外部人员现场维修情况记录</span>
                ...
                <div class="tab-pane active" id="tab_15_1"
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">维修人姓名</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.repairManName" name="repairManName"  required="true" ng-disabled="!processInstance.firstTask" />
                                        <span class="input-group-btn" >
                                                <button class="btn default" type="button" ng-click="vm.showUserModel('repairMan');" ng-disabled="!processInstance.firstTask"><i class="fa fa-user"></i></button>
                                             </span>
                                    </div>
                                </div>
                                <label class="col-md-2 control-label required">维修人身份证号</label>
                                <div class="col-md-4">
                                    <input  type="text" class="form-control" ng-model="vm.item.repairIdCard" name="repairIdCard" required="true"   ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">联系电话</label>
                                <div class="col-md-4">
                                    <input  type="text" class="form-control" ng-model="vm.item.repairTel" name="repairTel" required="true"   ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.solveWay"  name="solveWay" placeholder="" ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label ">维修结果</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.result"  name="result" placeholder="" ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">是否更换部件</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label ">拆除部件接收人</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                ...
                                <label class="col-md-2 control-label ">陪同人</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label ">部件拆除情况</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.removelSituation"  name="removelSituation" placeholder="" ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label ">部件更换情况</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.changeSituation"  name="changeSituation" placeholder="" ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
