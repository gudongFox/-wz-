        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                        <%--    <label style="margin-right: 10px;">文件名称：<input type="search"
                    ...
                    <div  class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer" >
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.deptName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong></td>
                                <td ng-bind="item.paymentTime"></td>
