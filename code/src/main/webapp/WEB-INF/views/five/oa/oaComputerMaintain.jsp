...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">非密信息化设备维修审批</span>
        </li>
    </ul>
</div>
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.maintainManName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.deviceName"></td>
                                <td ng-bind="item.deviceNo"></td>
                                <td ng-bind="item.deviceRoom"></td>
                                <td ng-bind="item.deviceLevel"></td>
