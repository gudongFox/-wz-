...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">职工入职审批单</span>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">职工入职审批单</span>
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.login" name="login" required="true" ng-disabled="!processInstance.firstTask" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="entryTime">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.entryTime" name="entryTime" required="true" ng-disabled="!processInstance.firstTask"  >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.entryDeptName" name="entryDeptName" required="true"   disabled/>
                                        <span class="input-group-btn" >
                                            <button class="btn default" type="button" ng-click="vm.showDeptModal(vm.opt='entryDeptId');" ng-disabled="!processInstance.firstTask"><i class="fa fa-cog"></i></button>
                                         </span>
                                    </div>
                                </div>
                            </div>
...
<jsp:include page="../print/print-oaEmployeeEntryExamineDetail.jsp"/>