                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>主管单位</th>
                                <th style="width: 90px">协会类型</th>
                                <th style="width: 60px">推荐负责人</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td  ng-bind="item.deptChargeName" ></td>
                                <td ng-bind="item.associationType"></td>
                                <td ng-bind="item.recommendManName"></td>
