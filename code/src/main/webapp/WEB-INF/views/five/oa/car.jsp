...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">车辆信息管理</span>
        </li>
    </ul>
</div>
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i>  <span ng-bind="tableName">车辆信息管理</span>
        </div>
        <div class="actions">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <label style="margin-right: 10px;">
                    <select ng-init="item.carType=carTypes[0]" ng-model="item.carType" ng-options="x for x in carTypes"></select>
                </label>
