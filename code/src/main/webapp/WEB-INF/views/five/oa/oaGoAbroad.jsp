    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span ng-bind="vm.params.dispatchType">因公出国内部审批文单</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <label style="margin-right: 10px;">事项描述：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">事项描述</th>
                                <th>主办单位</th>
                                <th style="width: 60px">拟稿人</th>
                                <th style="width: 100px" >因公出国领导</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.title"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.deptName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.drafterName"></td>
                                <td ng-bind="item.allottedTime"></td>
