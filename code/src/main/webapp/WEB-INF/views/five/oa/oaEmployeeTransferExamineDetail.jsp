...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">职工内部调整审批单</span>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">职工内部调整审批单</span>
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="transferTime">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.transferTime" name="transferTime" required="true" ng-disabled="!processInstance.firstTask"  >
                                        <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.transferDeptName" name="transferDeptName" required="true"   disabled/>
                                        <span class="input-group-btn" >
                                            <button class="btn default" type="button" ng-click="vm.showDeptModal(vm.opt='transferDeptId');" ng-disabled="!processInstance.firstTask"><i class="fa fa-cog"></i></button>
                                         </span>
                                    </div>
                                </div>
                            </div>
...
<jsp:include page="../print/print-oaEmployeeTransferExamineDetail.jsp"/>
