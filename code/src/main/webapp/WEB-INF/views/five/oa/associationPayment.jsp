                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">协会名称</th>
                                <th>主管单位</th>
                                <th>协会编码</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.associationName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong></td>
                                <td ng-bind="item.deptChargeName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.associationNo"></td>
                                <td ng-bind="item.recommendMan"></td>
                                <td ng-bind="item.paymentMoney |currency:'￥'"></td>
