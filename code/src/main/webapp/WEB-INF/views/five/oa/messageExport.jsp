    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span>个人非密信息导出审批单</span>
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.userName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.userLogin"></td>
                                <td ng-bind="item.deptName"  class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.applyTime"  ></td>
