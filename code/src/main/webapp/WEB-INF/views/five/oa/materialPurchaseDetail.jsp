                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.item.applicantManName" name="applicantManName"  required="true" ng-disabled="!processInstance.firstTask" />
...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-file"></i> 资料采购 <span style="margin-left: 5px;font-size: 12px">本数总计：&nbsp;<span style="color: green;font-size: 16px" ng-bind="vm.item.contNums"></span>本</span></div>
        <div class="actions">
        ...
        <div class="table-scrollable" style="max-height: {{contentHeight-250}}px;overflow-y: auto;overflow-x: hidden;">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="detail in vm.details">
                    ...
                    <td ng-bind="detail.standardNo" class="data_title" ng-click="vm.showDetailModel(detail.id);"></td>
                    <td ng-bind="detail.dataName"></td>
                    <td ng-bind="detail.bookNumber"></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">资料采购</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="detailForm">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-4 control-label">标准号</label>
                            <div class="col-md-7">
                                <input type="text" class="form-control" ng-model="vm.detail.standardNo" name="standardNo" required="true" ng-disabled="!processInstance.firstTask">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">资料名称</label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" ng-model="vm.detail.dataName" name="dataName" required="true" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">本数</label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" ng-model="vm.detail.bookNumber" name="bookNumber" required="true" >
                        </div>
                    </div>
                    <div class="form-group">
