        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                          <%--  <label style="margin-right: 10px;">申请部门：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>会议通知</th>
                                <th style="width:90px">是否派人参加</th>
                                <th style="width: 100px" >拟派人员</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.meetName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.meetNotic" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.attend"></td>
                                <td ng-bind="item.attendManName"></td>
