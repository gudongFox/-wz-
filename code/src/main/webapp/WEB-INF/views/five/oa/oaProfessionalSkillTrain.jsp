                    ...
                    <div  class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.applyDeptName"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.trainType" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.trainAddress"></td>
                                <td ng-bind="item.trainTime"></td>
