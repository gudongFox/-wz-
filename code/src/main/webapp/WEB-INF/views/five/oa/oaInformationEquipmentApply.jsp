                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 90px;">采购审批编号</th>
                                <th>联系人</th>
                                <th>申请单位</th>
                                <th style="width: 100px">是否预算内</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.formNo"  class="data_title"  ng-click="vm.show(item.id);"></td>
                                <td ng-bind="item.linkManName"  ></td>
                                <td ng-bind="item.deptName" ></td>
                                <td>
                                    <span ng-if="item.plan">是</span>
                                    <span ng-if="!item.plan">否</span>
                                </td>
