        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <%--<label style="margin-right: 10px;">编号|事项：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="width: 120px">公司办编号</th>
                                <th style="min-width: 200px;">事项</th>
                                <th style="width: 120px" class="hidden-md hidden-sm">送签部门</th>
                                <th style="width: 90px">发起人</th>
                                <th style="width: 100px">报送日期</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.officeNo"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.reportContent" ></td>
                                <td ng-bind="item.deptName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.creatorName"></td>
                                <td ng-bind="item.reportTime"></td>
