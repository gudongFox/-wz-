...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">外部科研项目申请</span>
        </li>
    </ul>
</div>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">外部科研项目申请</span>
                ...
                <div class="tab-pane active" id="tab_15_1"
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="commencementDate">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.commencementDate" name="commencementDate" required="true"  readonly />
                                        <span class="input-group-btn">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group date date-picker" id="completionDate">
                                        <input type="text" class="form-control"
                                               ng-model="vm.item.completionDate" name="completionDate" required="true"  readonly />
                                        <span class="input-group-btn">
                                            <button class="btn default" type="button" ng-disabled="!processInstance.firstTask"><i class="fa fa-calendar"></i></button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">本年度还款（万元）</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.yearRepayment" name="yearRepayment"  required="true" ng-disabled="!processInstance.firstTask" />
                                </div>
