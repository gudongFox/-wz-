        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                           <%-- <label style="margin-right: 10px;">中心名称：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">中心名称</th>
                                <th>依托单位</th>
                                <th>研究方向</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.centerName"  class="data_title"  ng-click="vm.show(item.id);"></td>
                                <td ng-bind="item.deptName"></td>
                                <td ng-bind="item.researchDirection"></td>
