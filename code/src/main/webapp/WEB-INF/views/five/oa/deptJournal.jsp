        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                           <%-- <label style="margin-right: 10px;">稿件题目：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">稿件题目</th>
                                <th>第一作者</th>
                                <th style="width:70px;min-width: 70px">审稿人</th>
                                <th style="width: 100px">投稿日期</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.manuscriptTitle"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.firstAuthor" ></td>
                                <td ng-bind="item.readerName"></td>
                                <td ng-bind="item.submitTime"></td>
