        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    ...
                    <%--<div class="row">
                        <div class="col-md-12">
                            <label style="margin-right: 10px;">文件标题：<input type="search"
                    ...
                    <div class="table-scrollable">
                        <table filter  class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 200px;">文件标题</th>
                                <th>来文单位</th>
                                <th style="width: 60px">签收人</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.fileTitle"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                <td ng-bind="item.sendDeptName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.signerName"></td>
                                <td ng-bind="item.receiveTime"></td>
