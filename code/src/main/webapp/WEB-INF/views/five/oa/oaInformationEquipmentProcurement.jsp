        ...
        <div class="portlet blue box">
            ...
            <div class="portlet-body">
                <div class="dataTables_wrapper no-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <label style="margin-right: 10px;">起始时间：
                    ...
                    <div class="table-scrollable">
                        <table filter class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>申请单位</th>
                                <th style="width: 100px">采购年份</th>
                                <th style="width: 100px">总计（元）</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render>
                                ...
                                <td ng-bind="item.procurementTime"></td>
                                <td ng-bind="item.firstMangerMan"></td>
