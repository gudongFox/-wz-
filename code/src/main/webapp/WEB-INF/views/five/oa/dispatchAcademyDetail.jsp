...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span >五洲工程设计研究院发文单</span>
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                     <input type="text" class="form-control" ng-model="vm.item.dispatchTitle" required="true" name="dispatchTitle" placeholder=""ng-disabled="!processInstance.firstTask"></input>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control" ng-model="vm.item.dispatch" required="true" name="dispatch" placeholder=""ng-disabled="!processInstance.firstTask"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
