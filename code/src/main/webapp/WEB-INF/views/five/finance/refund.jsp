    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span >还款</span>
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>单据号</th>
                                <th>单据状态</th>
                                <th ng-if="vm.item.shouldRefundMoney!='0'&&vm.item.shouldRefundMoney!=''">待还款总额</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-if="vm.item.shouldRefundMoney!='0'&&vm.item.shouldRefundMoney!=''" ng-bind="item.shouldRefundMoney"></td>
