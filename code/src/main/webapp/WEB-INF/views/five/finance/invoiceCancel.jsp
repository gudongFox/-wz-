                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th >合同号</th>
                                <th >法人单位</th>
                                <th class="hidden-md hidden-sm">申请人</th>
                                <th class="hidden-md hidden-sm">电话</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.applyManName" class="hidden-md hidden-sm"></td>
                                <td ng-bind="item.applyManTel" class="hidden-md hidden-sm"></td>
