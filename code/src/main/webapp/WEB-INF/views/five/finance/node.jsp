...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a ui-sref="business.contract">票据管理</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <span ng-bind="tableName">票据管理</span>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span ng-bind="tableName"></span>票据管理
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.type"  class="data_title"  ng-click="vm.show(item.id);"><strong ></strong>
                                </td>
                                ...
                                <td style="color: red" ng-if="item.incomeId==0">未认领</td>
                                <td style="color: green" ng-if="item.incomeId!=0" ng-click="vm.showIncome(item.incomeId)">已认领</td>
