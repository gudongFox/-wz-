...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">资金余额上报</span>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i><span ng-bind="tableName">资金余额上报</span>
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        ...
                        <div ng-controller="RedHeaderController as rh">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <%--原内容 <a href="#" ng-click="rh.readDocOnly(vm.item.businessKey)" ng-bind="redheadFile.fileName"></a>--%>&nbsp;&nbsp;
