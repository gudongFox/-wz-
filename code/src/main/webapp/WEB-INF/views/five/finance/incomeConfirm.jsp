...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span ng-bind="tableName">收入确认库(各单位)</span>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-note"></i> <span ng-bind="tableName">收入确认库(各单位)</span>
                </div>
                <div class="actions">
                    ...
                    <div class="table-scrollable">
                        <table filter  class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th style="width: 70px">收入类型</th>
                                <th class="hidden-md hidden-sm">收入来源账户</th>
                                <th class="hidden-md hidden-sm">收入来源账户名称</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list" on-finish-render="">
                                ...
                                <td ng-bind="item.fiveFinanceIncome.sourceName" class="hidden-md hidden-sm"></td>
                                ...
                                <%--<td ng-if="item.processEnd">
                                    <span style="color: green" ng-click="vm.getNotarizeIncome(item.id,item.creator);">已确认</span>
                                </td>
                                <td ng-if="!item.processEnd">
                                    <span style="color: red" ng-click="vm.getNotarizeIncome(item.id,item.creator);">未确认</span>
                                </td>--%>
                                <td>
