    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <div >
                ...
                <a href="javascript:;" class="btn btn-sm btn-default" ng-show="vm.canSave" style="font-size: 14px;line-height: 1.6"
                   ng-click="vm.save();" >
                    ...
                    <form class="form-horizontal form" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.name as s.name for s in sysCodes | filter:{codeCatalog:'使用类别'}:true"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.name as s.name for s in sysCodes | filter:{codeCatalog:'计算机使用情况'}:true"
                                            ng-model="vm.item.useStatus" class="form-control"></select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">光驱类型</label>
                                <div class="col-md-4">
                                    <select ng-options="s.name as s.name for s in sysCodes | filter:{codeCatalog:'光驱类型'}:true"
