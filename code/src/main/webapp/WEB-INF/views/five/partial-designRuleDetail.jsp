...
<div class="portlet  box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a class="btn btn-sm btn-default" ng-href="{{'/five/designRule/exportData.json?id='+vm.item.id}}"
               target="_blank">
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" rows="4" ng-model="vm.item.remark" name="remark" ng-disabled="!processInstance.firstTask" required maxlength="400"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <p class="text-right"><a href="/assets/doc/five/设计指导性文件编制规定.doc" target="_blank" style="text-decoration: none;">设计指导性文件编制规定.doc</a> </p>
                        </div>
                    </form>
                </div>
