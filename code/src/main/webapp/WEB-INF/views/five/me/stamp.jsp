...
<div class="page-bar" id="pageBar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a ui-sref="oa.functionEntrance">项目管理</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
            <a>成果用印审批</a>
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i> 成果用印审批<span ng-bind=" vm.technologyType">s</span>
        </div>
        <div class="actions">
            ...
            <div >
                ...
                <label style="margin-left: 20px;margin-right: 20px;"> 用印类别：
                    <select class="form-control input-inline input-sm"  ng-model="vm.params.types">
                        <option value="施工图报审章,施工图专用章,压力管道章,合同章">全部</option>
                        <option value="施工图报审章">施工图报审章</option>
                        <option value="施工图专用章">施工图专用章</option>
                        <option value="压力管道章">压力管道章</option>
