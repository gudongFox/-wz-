            ...
            <div class="table-scrollable">
                <table class="table table-striped table-hover table-bordered table-advance no-footer">
                    ...
                    <tr>
                        ...
                        <th>申请单位</th>
                        <th style="width: 70px;">项目总师</th>
                        <th>涉及专业</th>
                        <th style="width: 100px;">希望评审时间</th>
                    ...
                    <tr ng-repeat="item in vm.list">
                        ...
                        <td ng-bind="item.totalDesigner"></td>
                        <td ng-bind="item.referSpecialty"></td>
                        <td ng-bind="item.planReviewTime"></td>
