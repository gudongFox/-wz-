...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i>  <span>成果用印审批表</span>
        </div>
        <div class="actions">

            <a href="javascript:;" class="btn btn-sm btn-default" ng-click="vm.loadPagedData();">
                <i class="fa fa-refresh"></i> 刷新 </a>
            <a href="javascript:;" class="btn btn-sm btn-default" title="未签合同用印申请" ng-click="vm.add();">
    ...
    <div class="portlet-body">
        <div class="row">
            <div>
                ...
                <label style="margin-right: 20px;">用印类型：<input type="search"
                                                               class="form-control input-inline input-sm"
                                                               placeholder="用印类型"
                                                               ng-model="vm.params.qDocType"></label>
        ...
        <div class="table-scrollable">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="item in  vm.pageInfo.list">
                    ...
                    <td ng-bind="item.projectName" style="color: blue" ng-click="vm.show(item.id,item.stampType);"></td>
                    ...
                    <td>
                     ...
                     <%--   <i class="fa fa-pencil margin-right-5" ng-click="vm.showDetail(item.businessKey);" title="项目详情"></i>--%>
