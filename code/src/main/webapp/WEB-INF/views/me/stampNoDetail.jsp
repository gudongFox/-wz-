...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-envelope-letter"></i> 未签合同用印申请
                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="项目名称"
                                           ng-model="vm.item.projectName" ng-disabled="!processInstance.firstTask" required/>
                                </div>
                                <label class="col-md-2 control-label">执行阶段</label>
                                <div class="col-md-4">
                                    <select ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:('设计评审阶段')}:true"
                                            ng-model="vm.item.stageName" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.contractMoney" name="contractMoney"ng-disabled="!processInstance.firstTask"/>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"><strong>用印成果类别</strong></label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"><strong>用印明细</strong></label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">用印事由</label>
                                <div class="col-md-10">
