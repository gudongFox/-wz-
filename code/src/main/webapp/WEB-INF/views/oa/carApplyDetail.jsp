...
<div class="portlet  box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-envelope-letter"></i> 用车申请
    ...
    <div class="portlet-body">
        <div class="tabbable-line">
            <ul class="nav nav-tabs ">
                <li class="">
                    <a href="#tab_detail_0" data-toggle="tab" aria-expanded="true">
                        车辆信息一览 </a>
                </li>
                <li class="active">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_detail_0"
                     style="min-height: 300px;overflow-y: auto;overflow-x: hidden;">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tbody>
                            <tr ng-repeat="item in vm.listAll">
                                <td>
                                    <input type="checkbox" class="cb_car" ng-checked="item.id==vm.item.id"  data-name="{{item}}" style="width: 20px;height: 20px;" />
                                </td>
                ...
                <div class="tab-pane " id="tab_detail_1"
                     style="min-height: 300px;overflow-y: auto;overflow-x: hidden;">
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">车辆详情</label>
                                <div class="col-md-10">
