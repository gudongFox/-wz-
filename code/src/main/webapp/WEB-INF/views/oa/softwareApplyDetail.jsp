                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="软件名称"
                                           ng-model="vm.item.softwareName" ng-disabled="!processInstance.firstTask" required/>
                                </div>
                                <label class="col-md-2 control-label required">所属部门</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.deptName" required="true"  name="deptName" ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label required">软件用途</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength ng-valid-required"
                                              ng-model="vm.item.softwarePurpose" name="softwarePurpose" ng-disabled="!processInstance.firstTask"
                                              required="true"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">软件介绍</label>
                                <div class="col-md-10">
                                    <textarea rows="3" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength ng-valid-required"
                                              ng-model="vm.item.softwareDesc" name="softwareDesc" ng-disabled="!processInstance.firstTask"
                                              required="true"></textarea>
                                </div>
                            </div>
                       <%--     <div class="form-group">
