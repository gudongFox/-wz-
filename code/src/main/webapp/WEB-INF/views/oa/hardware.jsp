...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-note"></i>  <span>硬件设备管理台账</span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body">
        <div class="row">
            <div >
                ...
                <a class="btn btn-sm green" href="/assets/doc/导出模板/硬件设备管理台账.xls" target="_blank"><i class="fa fa-cloud-download"></i> 下载模板 </a>
        ...
        <div class="table-scrollable">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="item in  vm.pageInfo.list">
                    ...
                    <td ng-bind="item.equipmentName" style="color: blue" ng-click="vm.show(item.id);"></td>
                    <td ng-bind="item.equipmentType"></td>
                    <td ng-bind="item.bank"></td>
                    <td ng-bind="item.parameter"></td>
