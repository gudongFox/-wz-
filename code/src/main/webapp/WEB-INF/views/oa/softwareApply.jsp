...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-doc"></i>  <span>购置软件申报</span>
        </div>
        <div class="actions">
    ...
    <div class="portlet-body">
        <div class="row">
            <div >
                <label style="margin-left: 20px;">软件名称：<input type="search"
        ...
        <div class="table-scrollable">
            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                ...
                <tr ng-repeat="item in  vm.pageInfo.list">
                    ...
                    <td ng-bind="item.softwareName"  class="data_title" ng-click="vm.show(item.id,item.stampType);"></td>
                    <td ng-bind="item.softwarePurpose"></td>
