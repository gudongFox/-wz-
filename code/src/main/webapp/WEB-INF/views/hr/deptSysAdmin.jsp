    ...
    <div class="col-md-3" style="padding-right: 0px;">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-tree"></i> 组织机构-系统管理员
                </div>
                <div class="tools">
                    ...
                    <div class="tab-pane active" id="dept_tab">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-sm green"   href="/hr/employee/downloadModel.json"><i class="fa fa-cloud-download"></i> 导出数据 </a>
                                <a class="btn btn-sm blue" ng-click="vm.addEmployee();"><i class="fa fa-plus"></i> 新增员工 </a>
                            </div>
                        </div>
                        <div class="table-scrollable">
                            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                                ...
                                <tr ng-repeat="employee in vm.pageInfo.list">
                                    ...
                                    <td ng-bind="employee.deptName"  class="data_title2"></td>
                                    <td ng-bind="employee.roleNames"  class="data_title2"></td>
                                    <td ng-bind="employee.positionNames"  class="data_title2"></td>
                                    <td ng-bind="employee.userType" ></td>
                                    <td ng-bind="employee.userStatus"> </td>
                                    <td>
                                        <i class="icon-wrench margin-right-5" ng-click="vm.showUserNo(employee.id);"
                                           title="姓名职工号修改"></i>
                                        <i class="fa fa-lock margin-right-5" ng-click="vm.resetPwd(employee.userLogin);"
                                           title="重置密码"></i>
                                        <i class="fa fa-trash-o" ng-show="user.userLogin!=employee.userLogin" ng-click="vm.remove(employee.userLogin);"
                                           title="删除"></i>
                                    </td>
                                </tr>
                                </tbody>
...
<%--修改职工号--%>
<div class="modal fade draggable-modal" id="updateEmployeeModal" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">职工号修改</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" role="form" style="padding-right: 30px;" id="employee_update_form">
                    <div class="form-body">
                        <div class="form-group">
                            <label class="col-md-3 control-label">用户姓名</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" required="true" ng-model="vm.hrEmployee.userName"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" required="true" name="userLogin"
                                       ng-model="vm.hrEmployee.userLogin" disabled
                                       placeholder="唯一标识">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            <input type="text" class="form-control" required="true" name="userNo"
                                   ng-model="vm.hrEmployee.userNo"/>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <button type="button" class="btn default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn blue" ng-click="vm.saveUserNo();">保存</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
