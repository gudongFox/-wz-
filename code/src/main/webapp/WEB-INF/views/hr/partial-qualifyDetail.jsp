                ...
                <div class="tab-pane active" id="tab_15_1"
                    ...
                    <form class="form-horizontal" role="form" id="detail_form" >
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">从事专业</label>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" ng-model="vm.qualify.projectType" required="true"
                                               disabled="disabled" />
                                        <span class="input-group-btn">
                                            <button class="btn default" type="button"  ng-click="vm.showProjectTypeModel();">
                                                <i class="fa fa-cog"></i>
                                            </button>
                                        </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" style="text-align: center">
                                    <select   ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'具备资格'}:true"
                                              ng-model="vm.qualify.projectCharge" class="form-control"></select>
                                </div>
                                <label class="col-md-2 control-label">执行项目负责人</label>
                                <div class="col-md-4" style="text-align: center">
                                    <select   ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'具备资格'}:true"
                                              ng-model="vm.qualify.projectExeCharge" class="form-control"></select>
                                </div>
                            </div>
...
<%--                                </div>--%>
<%--                                <label class="col-md-2 control-label">具有总设计师资格</label>--%>
<%--                                <div class="col-md-4" style="text-align: center">--%>
<%--                                    <select   ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'具备资格'}:true"--%>
<%--                                             ng-model="vm.qualify.chiefDesigner" class="form-control"></select>--%>
<%--                                </div>--%>
<%--                                <label class="col-md-2 control-label">是否兼职总设计师</label>--%>
<%--                                <div class="col-md-4" style="text-align: center">--%>
<%--                                    <select   ng-options="s.codeValue as s.name for s in sysCodes | filter:{codeCatalog:'具备资格'}:true"--%>
                ...
                <div class="table-scrollable" style="max-height: 400px">
                    <table class="table table-striped table-hover table-bordered table-advance no-footer">
                        ...
                        <tr ng-repeat="projectType in vm.projectTypes">
                            <td>
                                <input type="checkbox" ng-checked="vm.qualify.projectType.indexOf(projectType.code)>=0" class="cb_projectType" data-name="{{projectType.code}}" style="width: 15px;height: 15px;"/>
                            </td>
