                    ...
                    <div class="tab-pane active" id="dept_tab">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-sm blue" ng-click="vm.addEmployee();"><i class="fa fa-plus"></i>
                                    新增</a>

                                <a class="btn btn-sm green" ng-click="vm.exportData();"><i
                                        class="fa fa-cloud-download"></i> 导出数据 </a>

                                <span id="btnUpload" class="btn btn-sm blue fileinput-button">
                                    <i class="fa fa-cloud-upload"></i>
                                                            <span>上传数据</span>
                                                            <span id="uploadProgress"></span>
                                       <input type="file" name="multipartFile" accept="*"/>
                                </span>

                                <div style="float: right;margin-right: 15px;margin-top: 5px">
                                    <input type="checkbox" id="showUserStatus" ng-click="vm.showUserStatus()"> 显示用户状态
                                </div>
                            </div>
                        </div>
                        <div class="table-scrollable">
                            <table class="table table-striped table-hover table-bordered table-advance no-footer">
                                ...
                                <tr>
                                    ...
                                    <th style="width:80px;">微信ID</th>
                                    <th>部门名称</th>
                                    <th>系统角色</th>
                                    <th>职务</th>
                                    <th style="width:90px;">员工类型</th>
                                    <th style="width:90px;" ng-if="vm.userStatus">员工状态</th>
                                ...
                                <tr ng-repeat="employee in vm.pageInfo.list|filter: {userStatus:vm.userFilfter}">
                                    ...
                                    <td ng-click="vm.detail(employee.userLogin)">
                                        <img alt="" class="img-circle"
                                             ng-src="{{employee.avatar==''?'/m/admin/layout/img/avatar9.jpg':employee.avatar}}"
                                             onerror="this.src='/m/admin/layout/img/avatar9.jpg'"
                                             style="height: 25px;width: 25px;border-radius: 5%;"/>
                                        <span ng-bind="employee.userName" class="data_title"></span>
                                    </td>
                                    <td ng-bind="employee.userNo"></td>
                                    <td ng-bind="employee.wxId"></td>
                                    <td>
                                        <span ng-bind="employee.deptName"></span>
                                        <i class="fa  fa-cog font-blue" title="部门"
                                           ng-click="vm.showDeptModal(employee);"></i>
                                    </td>
                                    <td>
                                        <span ng-bind="employee.roleNames"></span>
                                        <i class="fa  fa-cog font-blue" title="角色"
                                           ng-click="vm.showRoleModal(employee);"></i>
                                    </td>
                                    <td>
                                        <span ng-bind="employee.positionNames"></span>
                                        <i class="fa  fa-cog font-blue" title="职务"
                                           ng-click="vm.showPositionModal(employee);"></i>
                                    </td>
                                    <td>
                                        <span ng-bind="employee.userType"></span>
                                        <i class="fa  fa-cog font-blue" title="员工类型"
                                           ng-click="vm.showTypeModal(employee);"></i>
                                    </td>
                                    <td ng-if="vm.userStatus">
                                        <span   ng-bind="employee.userStatus"></span>
                                        <i class="fa  fa-cog font-blue" title="员工状态"
                                           ng-click="vm.showStatusModal(employee);"></i>
                                    </td>
                                    <td>
                                        <i class="fa fa-cog margin-right-5" ng-click="vm.showUserDeptConfig(employee);"
                                           title="用户权限配置"></i>
                                        <i class="fa fa-trash-o" ng-show="user.userLogin!=employee.userLogin"
                                           ng-click="vm.remove(employee.userLogin);"
                                           title="删除"></i>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <div class="tab-pane " id="info_tab">
                        <form class="form-horizontal form" role="form" id="detail_form">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ng-model="vm.item.deptFirstLeaderName" name="deptFirstLeaderName"/>
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"
                                                    ng-click="vm.showUserModel('first');"><i
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   ng-model="vm.item.deptSecondLeaderName" name="deptSecondLeaderName"/>
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"
                                                    ng-click="vm.showUserModel('second');"><i
                                                    class="fa fa-user"></i></button>
                                         </span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input type="text" class="form-control" ng-model="vm.item.deptChargeManName"
                                                   name="deptChargeManName"/>
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"
                                                    ng-click="vm.showUserModel('charge');"><i
                                                    class="fa fa-user"></i></button>
                                         </span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions right" style="padding: 10px;">
                                <button type="button" class="btn blue btn-sm" ng-click="vm.update();"
                                        ng-disabled="vm.item.parentId==0">保存
                                </button>
                                <button type="button" class="btn default btn-sm" ng-click="vm.loadDept();"
                                        ng-disabled="vm.item.parentId==0">重置
                                </button>
                            </div>
                        </form>
                    </div>
...
<div class="modal fade draggable-modal" id="statusSelectModal" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            <div class="modal-body">
                ...
                <div class="table-scrollable" style="max-height: 450px;overflow-y: auto;">
                    <table class="table table-striped table-hover table-bordered table-advance no-footer">
                        ...
                        <tbody>
                        <tr ng-repeat="item in vm.status">
                            <td>
                                <input type="checkbox" ng-checked="vm.current.userStatus.indexOf(item.code)>=0"
                                       class="cb_status" data-name="{{item.code}}"/>
                            </td>
                            <td ng-bind="item.code"></td>
                        </tr>
                        </tbody>
            ...
            <div class="modal-footer">
                <button type="button" class="btn default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn blue" ng-click="vm.saveStatus();">确认</button>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                    <button class="btn default" type="button"
                                            ng-click="vm.showDeptModalById(vm.employee.deptId);"><i
                                            class="fa fa-cog font-blue"></i></button>
                                </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.myAclInfoList|filter:{name:vm.qMyAcl}">
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-trash margin-right-5" ng-click="vm.removeUserAclById(item);"
                                       ng-show="item.allConfig" style="color: red;"></i>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-trash margin-right-5" ng-click="vm.removeUserAclOptById(item);"
                                       ng-show="item.optConfig" style="color: red;"></i>
                                </td>
                                <td>
                                    <i class="fa fa-cog margin-right-5"
                                       ng-click="vm.showUserAclDeptSelectModal(item);"></i>
                                    <i class="fa fa-trash margin-right-5" ng-click="vm.removeUserAclDeptById(item);"
                                       ng-show="item.deptConfig" style="color: red;"></i>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<div class="modal fade draggable-modal" id="userAclSelectModal" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <span style="color: red;cursor: pointer;float: left;" ng-show="vm.currentUser.aclConfig"
                      ng-click="vm.removeUserAcl();">删除用户独立配置权限</span>
                <button type="button" class="btn default" data-dismiss="modal">关闭</button>
