                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>奖励名称</th>
                                <th style="width: 90px">颁奖单位</th>
                                <th style="width: 90px">获奖时间</th>
                                <th style="width: 90px">荣誉级别</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.honorName"></td>
                                <td ng-bind="item.honorUnits"></td>
                                <td ng-bind="item.honorDate"></td>
                                <td ng-bind="item.honorLevel"></td>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-trash-o " ng-click="vm.remove(item.id);" title="删除" ng-show="item.userLogin==user.userLogin&&!item.processEnd"></i>
                                </td>
                            </tr>
                            </tbody>
                        </table>
