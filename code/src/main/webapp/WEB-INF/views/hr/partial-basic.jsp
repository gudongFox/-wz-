                ...
                <form class="form-horizontal form" role="form" id="detail_form">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" ng-model="vm.item.userName" disabled="disabled"
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" ng-model="vm.item.userLogin"
                                       name="userLogin" required="true" maxlength="20" disabled="disabled"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="multipartFile" id="uploadSignFile"
                                ...
                                <span class="help-block" style="font-size :14px;color: red;letter-spacing: 2px">请使用 <a href="/assets/doc/std/sign.dwg" class="a_title" target="_blank">签名模板</a> 在规定位置合理签名,保存为2007格式</span>
                            </div>
