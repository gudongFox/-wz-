    ...
    <div class="col-md-12">
        <div class="portlet blue box">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-database"></i> 员工个人收入证明
                </div>
            </div>
                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.userName"  class="data_title" ng-click="vm.showDetail(item.id);"></td>
                                <td ng-bind="item.idCardNo"></td>
                                <td ng-bind="item.workYearNumber"></td>
                                <td ng-bind="item.workPosition"></td>
                                <td ng-bind="item.yearIncome"></td>
                                <td ng-bind="item.monthIncome"></td>
                                <td ng-bind="item.gmtCreate"></td>
                                <td>
                                    <span ng-bind="item.processInstanceName"></span>
                                </td>
                                <td> <i class="fa fa-print mr-5" ng-click="vm.print(item.id);" title="打印"></i></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
