                    ...
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr>
                                ...
                                <th>工程名称</th>
                                <th>客户名称</th>
                                <th style="width: 60px">勘察负责人</th>
                                <th style="width: 60px">设计负责人</th>
                                <th style="width: 60px">施工负责人</th>
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td ng-bind="item.exploreManName"></td>
                                <td ng-bind="item.designManName"></td>
                                <td ng-bind="item.constructionManName"></td>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-plus" ng-click="vm.addContract(item.id);" title="创建经营合同" ng-show="item.creator==user.userLogin&&item.processEnd" ></i>
                                </td>
                            </tr>
                            </tbody>
                        </table>
