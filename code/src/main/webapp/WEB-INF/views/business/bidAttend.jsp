                        ...
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tr ng-repeat="item in vm.pageInfo.list">
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-plus" ng-click=" vm.addProjectCharge(item.id);" ng-show="item.creator==user.userLogin&&item.processEnd" title="创建项目负责人确认表"></i>
                                </td>
                            </tr>
                            </tbody>
                        </table>
