                    ...
                    <form class="form-horizontal" role="form" id="detail_form">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-2 control-label">报审部门</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
										...
										<button class="btn default" type="button" ng-click="vm.listProjectCharge()" ng-disabled="!processInstance.firstTask"><i class="fa fa-cog"></i></button>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-md-2 control-label">项目地点</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectAddress" ng-disabled="!processInstance.firstTask" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">合同工期</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectTime" ng-disabled="!processInstance.firstTask"/>
                                </div>

                                <label class="col-md-2 control-label">质量要求</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectQuality" name="projectQuality" required="true" ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select ng-options="s.name  as s.name for s in sysCodes | filter:{codeCatalog:'合同类型'}:true"
                                            ng-model="vm.item.contractType" class="form-control" ng-disabled="!processInstance.firstTask"></select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">工程价格</label>
                                <div class="col-md-4">
                                    <input  class="form-control" ng-model="vm.item.contractMoney" name="contractMoney" required="true" ng-disabled="!processInstance.firstTask" />
                                </div>
                                <label class="col-md-2 control-label">费率</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.contractRate" ng-disabled="!processInstance.firstTask"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label required">项目规模</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" ng-model="vm.item.projectScale" name="projectScale" required ng-disabled="!processInstance.firstTask" />
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label required">保证金（保函）条件</label>
                                <div class="col-md-10">
                                    <textarea rows="1" class="form-control" ng-model="vm.item.guaranteeRule" required="true"  name="guaranteeRule"
                                              ng-disabled="!processInstance.firstTask" placeholder=""></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2 control-label">工程款支付条件</label>
                                <div class="col-md-10">
                                    <textarea rows="1" class="form-control" ng-model="vm.item.paymentRule"  name="paymentRule"
                                              ng-disabled="!processInstance.firstTask" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">工程内容</label>
                                <div class="col-md-10">
                                    <textarea rows="2" class="form-control" ng-model="vm.item.projectContent"  name="projectContent"
                                              ng-disabled="!processInstance.firstTask" placeholder=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<div class="modal fade" id="projectCharge" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title" >项目负责人确认表</h4>
            </div>
                ...
                <div class="dataTables_wrapper no-footer">
                    ...
                    <div class="table-scrollable" style="max-height: 400px;overflow-y: auto;">
                        <table class="table table-striped table-hover table-bordered table-advance no-footer">
                            ...
                            <tbody>
                            <tr ng-repeat="projectCharge in vm.list|filter:{projectName:vm.qName}|filter:{deptName:vm.deptName}">
                                <td>
                                    <input type="checkbox" class="cb_bigProjectCharge" ng-checked="vm.item.bidProjectChargeId==projectCharge.id"  data-name="{{projectCharge}}" style="width: 15px;height: 15px;"/>
                                </td>
                                <td ng-bind="projectCharge.projectName"></td>
                                <td ng-bind="projectCharge.customerName"></td>
                                <td ng-bind="projectCharge.deptName"></td>
                                <td ng-bind="projectCharge.creatorName"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn blue" ng-click="vm.chooseProjectCharge();">保存</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<jsp:include page="print/print-bidContract.jsp"/>