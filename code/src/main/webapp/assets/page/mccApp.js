...
function initApp() {
    ...
    var mccApp = angular.module(appName, ['ui.router', 'ui.router.state.events', 'ui.my.directives', "services.common", "controllers.common", "services.act", "controllers.act",
        ...
        .config(function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider,$sceDelegateProvider) {
            ...
            $stateProvider
                ...
                .state('five.businessRecordDetailManger', {
                    url: "/businessRecordDetailManger?recordId",
                    templateUrl: function () {
                        return "/five/business/recordDetailManger";
                    },
                    controller: 'FiveBusinessRecordDetailMangerController as vm'
                })
    ...
    mccApp.run(function ($rootScope, $state, actProcessQueryService, actProcessHandleService, actTaskQueryService, actTaskHandleService, commonUserService) {
        ...
        $rootScope.initMetronic = function () {
            Metronic.init();
        }
            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    var ckeditor = CKEDITOR.replace(element[0], {
                        ...
                        uploadUrl: '/common/attach/editorUpload.json',
                        filebrowserUploadUrl: '/common/attach/editorUpload.json',
                        filebrowserImageUploadUrl: '/common/attach/editorUpload.json',
                        ...
                        contentsCss: [
                            ...
                            '/assets/ckeditor/pastefromword.css'
                        ],
