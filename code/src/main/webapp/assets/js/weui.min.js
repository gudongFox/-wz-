...
!function (e, t) {
    ...
    return function (e) {
        ...
        var o = n(1), a = i(o), r = n(7), u = i(r), l = n(8), s = i(l), d = n(9), f = i(d), c = n(11), p = i(c),
            h = n(13), v = i(h), m = n(15), y = i(m), w = n(17), g = i(w), _ = n(18), b = i(_), k = n(19), x = i(k),
            M = n(20), C = i(M), j = n(24), E = n(30), S = i(E), O = n(32), P = i(O);
        t.default = {
            dialog: a.default,
            alert: u.default,
            confirm: s.default,
        ...
        function o() {
            ...
            var o = (0, r.default)(r.default.render(l.default, n)), a = o.find(".weui-dialog"),
                u = o.find(".weui-mask");
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(6), l = i(u), s = void 0;
        ...
        function o() {
            ...
            var n = (0, r.default)(r.default.render(l.default, t)), i = n.find(".weui-toast"), o = n.find(".weui-mask");
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(10), l = i(u), s = void 0;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        function o() {
            ...
            var o = (0, r.default)(r.default.render(l.default, i)), a = o.find(".weui-toast"), u = o.find(".weui-mask");
            return (0, r.default)("body").append(o), a.addClass("weui-animate-fade-in"), u.addClass("weui-animate-fade-in"), s = o[0], s.hide = t, s
        }

        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(12), l = i(u), s = void 0;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        function o() {
            ...
            var u = (0, r.default)(r.default.render(l.default, o)), d = u.find(".weui-actionsheet"),
                f = u.find(".weui-mask");
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(14), l = i(u), s = void 0;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(16), l = i(u), s = null;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        function o(e) {
            ...
            return t.forEach(function (e) {
                ...
                var n = (0, r.default)(e), i = n.find(".weui-search-bar__label"), o = n.find(".weui-search-bar__input"),
                    a = n.find(".weui-icon-clear"), u = n.find(".weui-search-bar__cancel-btn");
                i.on("click", function () {
            ...
            if ("INPUT" == i.tagName || "TEXTAREA" == i.tagName) {
                ...
                var s = function () {
                    var e = t.find('input[type="checkbox"][name="' + i.name + '"]'),
                        n = a.replace(/[{\s}]/g, "").split(","), o = 0;
                    if (2 != n.length) throw i.outerHTML + " regexp is wrong.";
                    return e.forEach(function (e) {
                        e.checked && ++o
                    }), "" === n[1] ? o >= parseInt(n[0]) ? {v: null} : {v: 0 == o ? "empty" : "notMatch"} : parseInt(n[0]) <= o && o <= parseInt(n[1]) ? {v: null} : {v: 0 == o ? "empty" : "notMatch"}
                }();
        ...
        function r(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : c.default.noop,
                n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = (0, c.default)(e);
            return i.forEach(function (e) {
                var i = (0, c.default)(e), o = i.find("[required]");
                "function" != typeof t && (t = l);
                for (var r = 0, u = o.length; r < u; ++r) {
                    var s = o.eq(r), d = a(s, i, n.regexp), f = {ele: s[0], msg: d};
        ...
        function u(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = (0, c.default)(e);
        ...
        function l(e) {
            if (e) {
                var t = (0, c.default)(e.ele), n = e.msg,
        ...
        function o(e, t) {
            ...
            var a = (0, r.default)(e), u = window.URL || window.webkitURL || window.mozURL;
            t = r.default.extend({
                url: "",
                auto: !0,
                type: "file",
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(21), l = i(u), s = n(22), d = n(23), f = i(d), c = 0;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        function a(e) {
            ...
            for (var n = t.byteLength, i = 2; i < n;) {
                ...
                if (i += 2, 65505 == o) {
                    ...
                    i += 2;
                    for (var u = 0; u < r; u++) if (274 == t.getUint16(i + 12 * u, a)) return t.getUint16(i + 12 * u + 8, a)
                } else {
        ...
        function u(e, t, u) {
            ...
            l.onload = function (l) {
                ...
                var s = new Image;
                s.onload = function () {
                    var l = n(s), d = a(i(s.src)), f = document.createElement("canvas"), c = f.getContext("2d"),
                        p = t.compress.width, h = t.compress.height, v = s.width, m = s.height, y = void 0;
                    if (v < m && m > h ? (v = parseInt(h * s.width / s.height), m = h) : v >= m && v > p && (m = parseInt(p * s.height / s.width), v = p), f.width = v, f.height = m, d > 0 && r(f, c, d), c.drawImage(s, 0, 0, v, m / l), y = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? f.toDataURL("image/jpeg", t.compress.quality) : f.toDataURL(e.type), "file" == t.type) if (/;base64,null/.test(y) || /;base64,$/.test(y)) u(e); else {
                        var w = o(y);
        ...
        function n(e) {
            var t = e.url, n = e.file, i = e.fileVal, o = e.onBeforeSend, a = e.onProgress, r = e.onError,
        ...
        function r() {
            ...
            function i(e, t) {
                if (void 0 === p[t] && r.defaultValue && void 0 !== r.defaultValue[t]) {
                    var n = r.defaultValue[t], o = 0, u = e.length;
                    if ("object" == l(e[o])) for (; o < u && n != e[o].value; ++o) ; else for (; o < u && n != e[o]; ++o) ;
                    o < u && (p[t] = o)
                }
                v.find(".weui-picker__group").eq(t).scroll({
                    items: e, temp: p[t], onChange: function (e, n) {
                        if (e ? c[t] = new a(e) : c[t] = null, p[t] = n, s) c.length == y && r.onChange(c); else if (e.children && e.children.length > 0) v.find(".weui-picker__group").eq(t + 1).show(), !s && i(e.children, t + 1); else {
            ...
            if (g) return g;
            var o = arguments[arguments.length - 1], r = d.default.extend({
                id: "default",
                className: "",
                container: "body",
        ...
        function u(e) {
            ...
            }, o = [], a = c.default.parse(n.cron, n.start, n.end), u = void 0;
            do {
                u = a.next();
                var l = u.value.getFullYear(), s = u.value.getMonth() + 1, f = u.value.getDate(), p = i(o, "value", l);
                p || (p = {label: l + "年", value: l, children: []}, o.push(p));
        ...
        var l = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        }, s = n(2), d = o(s), f = n(25), c = o(f);
        n(26);
        var p = n(27), h = i(p), v = n(28), m = o(v), y = n(29), w = o(y);
        ...
        function o(e, t, n) {
            var o = e.replace(/^\s\s*|\s\s*$/g, "").split(/\s+/), a = [];
        ...
        r.default.fn.scroll = function (e) {
            ...
            function i(e) {
                if (y) {
                    var t = (new Date).getTime(), n = k - p.bodyHeight / 2;
                    if (w = e, t - g > 100) C(Math.abs(w - y) > 10 ? w - y : n - w); else if (Math.abs(w - y) > 10) {
                        for (var i = b.length - 1, o = i, a = i; a > 0 && g - b[a].time < 100; a--) o = a;
                        if (o !== i) {
                            var r = b[i], u = b[o], l = r.time - u.time, s = r.y - u.y, d = s / l,
                                f = 150 * d + (w - y);
                            C(f)
                        } else C(0)
                    } else C(n - w);
            ...
            var a = this, p = r.default.extend({
                items: [], scrollable: ".weui-picker__content", offset: 3, rowHeight: 34, onChange: r.default.noop,
                temp: null, bodyHeight: 238
            ...
            var m = v.find(p.scrollable), y = void 0, w = void 0, g = void 0, _ = void 0, b = [],
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = n(2), r = i(a), u = n(31), l = i(u), s = void 0;
        t.default = o, e.exports = t.default
    }, function (e, t) {
        ...
        function o(e) {
            ...
            return n.forEach(function (e) {
                ...
                var o = (0, r.default)(e), a = o.find(".weui-slider__inner"), u = o.find(".weui-slider__track"),
                    l = o.find(".weui-slider__handler"), s = parseInt(r.default.getStyle(a[0], "width")),
                    d = a[0].offsetLeft, f = 0, c = 0, p = void 0;
