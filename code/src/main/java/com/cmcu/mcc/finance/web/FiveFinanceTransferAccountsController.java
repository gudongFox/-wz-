...
@RestController
@RequestMapping("/five/finance/transferAccounts")
public class FiveFinanceTransferAccountsController {
    @Autowired
    ...
    @PostMapping("/getAccountNumber.json")
    public JsonData getAccountNumber(int id){return  JsonData.success(fiveFinanceTransferAccountsService.getAccountNumber(id));}
}
