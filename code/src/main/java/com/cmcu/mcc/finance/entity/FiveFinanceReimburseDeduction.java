...
@Data
public class FiveFinanceReimburseDeduction {
    ...
    @NotNull(message="relevanceBusinessKey不能为空!")
    @Size(max=45, message="relevanceBusinessKey长度不能超过45")
    private String relevanceBusinessKey;
