...
@Data
public class BusinessSubpackage {
    ...
    @Size(max=450, message="主合同名称长度不能超过450")
    ...
    @Size(max=450, message="分包合同名称长度不能超过450")
    ...
    @NotNull(message="采购 项目备案不能为空!")
    @Max(value=999999999, message="采购 项目备案必须为数字")
    private Integer recordId;

    @NotNull(message="项目备案不能为空!")
    @Size(max=145, message="项目备案长度不能超过145")
