...
@RestController
@RequestMapping("/five/budget/independent")
public class FiveBudgetIndependentController {
    @Autowired
    ...
    @PostMapping("/getDetailByDetailId.json")
    public JsonData getDetailByDetailId(int id) {
        return JsonData.success(fiveBudgetIndependentService.getDetailByDetailId(id));
    }
    ...
    @PostMapping("/refreshBudgetDetail.json")
    public JsonData refreshBudgetDetail(int id) {
        fiveBudgetIndependentService.refreshBudgetDetail(id);
        return JsonData.success();
    }
    @PostMapping("/getBudgetIdByDeptId.json")
    public JsonData getBudgetIdByDeptId(String budgetType,int deptId,String budgetYear) {
        return JsonData.success( fiveBudgetIndependentService.getBudgetIdByDeptId(budgetType,deptId,budgetYear));
    }
    @PostMapping("/getPublicBudgetById.json")
    public JsonData getPublicBudgetById(int deptId,String budgetYear) {
        return JsonData.success( fiveBudgetIndependentService.getPublicBudgetById(deptId,budgetYear));
    }
