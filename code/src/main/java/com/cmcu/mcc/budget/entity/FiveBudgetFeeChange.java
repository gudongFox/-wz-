...
@Data
public class FiveBudgetFeeChange {
    ...
    @NotNull(message="totalBudgetMoney不能为空!")
    @Size(max=45, message="totalBudgetMoney长度不能超过45")
    ...
    @NotNull(message="budgetYear不能为空!")
    @Size(max=45, message="budgetYear长度不能超过45")
