...
public class FiveOaDispatch {
    ...
    @Size(max=45, message="拟稿人姓名长度不能超过45")
    ...
    @Size(max=450, message="发文标题长度不能超过450")
    private String dispatchTitle;

    @NotNull(message="主送人不能为空!")
    @Size(max=45, message="主送人长度不能超过45")
    ...
    @Size(max=45, message="抄送长度不能超过45")
    ...
    @Size(max=45, message="主题词长度不能超过45")
    ...
    @Size(max=45, message="typistName长度不能超过45")
    private String typistName;

    @NotNull(message="proofreader不能为空!")
    @Size(max=45, message="proofreader长度不能超过45")
    private String proofreader;

    @NotNull(message="proofreaderName不能为空!")
    @Size(max=45, message="proofreaderName长度不能超过45")
    ...
    @Size(max=45, message="word长度不能超过45")
    private String word;

    @Size(max=45, message="year长度不能超过45")
    private String year;

    @Max(value=999999999, message="mark必须为数字")
    private Integer mark;

    @Size(max=145, message="copyMen长度不能超过145")
    private String copyMen;

    @Size(max=450, message="copyMenName长度不能超过450")
    private String copyMenName;
}