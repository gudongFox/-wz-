...
(function (factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('jstree.node_customize', ['jquery','static/assets/vakata-jstree-3.3.8/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/assets/vakata-jstree-3.3.8/src/jstree'));
	}
	else {
...
(function (factory) {
        "use strict";
        if (typeof define === 'function' && define.amd) {
                define('jstree.parentsload', ['jquery','static/assets/vakata-jstree-3.3.8/src/jstree'], factory);
        }
        else if(typeof exports === 'object') {
                factory(require('jquery'), require('static/assets/vakata-jstree-3.3.8/src/jstree'));
        }
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionaldeselect', ['jquery','static/assets/vakata-jstree-3.3.8/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/assets/vakata-jstree-3.3.8/src/jstree'));
	}
...
(function (factory) {
	"use strict";
	if (typeof define === 'function' && define.amd) {
		define('jstree.conditionalclose', ['jquery','static/assets/vakata-jstree-3.3.8/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('static/assets/vakata-jstree-3.3.8/src/jstree'));
	}
