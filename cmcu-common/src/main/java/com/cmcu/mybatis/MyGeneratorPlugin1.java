...
public class MyGeneratorPlugin1 extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document,
        ...
        XmlElement dept = new XmlElement("if");
        dept.addAttribute(new Attribute("test", "deptId != null and isLikeSelect!=null"));
        dept.addElement(new TextElement(" AND dept_id = #{deptId}"));

        where1.addElement(iff);
        where1.addElement(dept);
